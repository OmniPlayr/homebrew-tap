class Omniplayr < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/OmniPlayr/OmniPlayr-CLI/releases/download/v0.0.11/omniplayr-macos-arm64"
      sha256 "b6785b17a39f7b9a3606689c657b500bdc17efe5fdf4872e5a095bdc48e38e0b"
    else
      url "https://github.com/OmniPlayr/OmniPlayr-CLI/releases/download/v0.0.11/omniplayr-macos-x64"
      sha256 "PLACEHOLDER"
    end
  end

  on_linux do
    url "https://github.com/OmniPlayr/OmniPlayr-CLI/releases/download/v0.0.11/omniplayr-linux"
